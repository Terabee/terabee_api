#ifndef I_TERARANGER_EVO_3M_HPP
#define I_TERARANGER_EVO_3M_HPP
...
/**
 * Interface to <a href="https://www.terabee.com/shop/lidar-tof-range-finders/teraranger-evo-3m/">TeraRanger Evo 3m</a> sensor.
 * \see
 *  - \ref ITerarangerFactory::createTerarangerEvo3m
 *  - \ref ExampleReadEvo3m.cpp
 */
class ITerarangerEvo3m
{
public:
  virtual ~ITerarangerEvo3m() = default;
  /**
